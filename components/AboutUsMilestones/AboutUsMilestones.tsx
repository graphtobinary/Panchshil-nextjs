    ...
    <section className=" py-14 md:py-20">
      <div className="max-w-[1320px] mx-auto px-6 md:px-10 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row gap-5 lg:gap-0 items-center">
          ...
          <div className="flex flex-row md:flex-col lg:w-[15%] shrink-0 justify-around md:justify-center gap-0 md:gap-0 w-full md:w-auto">
            {content.milestones.map((milestone, index) => {
              const isActive = index === activeIndex;
              return (
                <div
                  className={`w-full md:w-auto md:pl-10 ${
                    isActive
                      ? isMobile
                ...
                >
                  <button
                    ...
                    className={`text-center md:text-left py-8 md:py-12 px-0 transition-colors cursor-pointer w-full text-black/40 hover:text-black/70 
                ${
