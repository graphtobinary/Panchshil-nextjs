...
export const accordionItems: AccordionData[] = [
  {
    ...
    stats: [
      { label: "11 Million sq.ft Developed" },
      { label: "4 Million sq.ft Under Development" },
    ],
  },
  {
    id: 2,
    ...
    image: "/assets/images/Office-Park2.jpg",
    stats: [
      { label: "23 Million sq.ft Developed" },
      { label: "32 Million sq.ft Under Development" },
    ],
  },
  {
    id: 3,
    ...
    stats: [
      { label: "2140 Rooms Developed" },
      { label: "1548 Rooms under development" },
    ],
  },
  {
    id: 4,
    ...
    stats: [
      { label: "0.7 Million sq.ft Developed" },
  ...
  },
  {
    ...
    stats: [
      { label: "1 Million sq.ft Developed" },
      { label: "6.9 Million sq.ft Under Development" },
    ],
  },
];
