            ...
            (item: NavigationMenuItemProps, i: number) => (
              ...
              >
                <Image
                  src={
                    isDarkMode
                      ? item.menuNightThumbnail || ""
                      : item.menuDayThumbnail || ""
                  }
                  alt={item.menuTitle}
                  fill
                ...
                {/* bottom gradient */}
                <div className="absolute inset-x-0 bottom-0 h-1/2 bg-linear-to-t from-black/80 via-black/50 to-transparent"></div>
