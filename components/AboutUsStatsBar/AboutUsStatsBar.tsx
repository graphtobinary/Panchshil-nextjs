...
type AboutUsStatsBarProps = {
  stats: AboutUsPageDummyData["stats"];
};
...
function AboutUsStatItem({
  ...
  return (
    ...
    >
      ...
      <span className="mt-1 text-base md:text-[20px] leading-tight font-display-semi text-black-chocolate text-center">
        {label}
      </span>
    </div>
  );
...
export default function AboutUsStatsBar({ stats }: AboutUsStatsBarProps) {
